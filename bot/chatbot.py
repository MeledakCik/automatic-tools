...
def start(update: Update, context: CallbackContext) -> None:
    keyboard = [
        ...
        [
            ...
            InlineKeyboardButton("10. Chat with GPT", callback_data='10'),
        ],
    ]
...
def button(update: Update, context: CallbackContext) -> None:
    ...
    elif selection == '10':  # New option for GPT chat
        context.user_data['current_option'] = '10'
        query.edit_message_text(text="Kirimkan pesan untuk ChatGPT:")
...
def handle_input(update: Update, context: CallbackContext) -> None:
    ...
    if current_option == '1':
    ...
    elif current_option == '10':  # GPT chat handler
        ...
        data = {
            "model": "text-davinci-003",  # or any other GPT model
            "prompt": user_input,
            "max_tokens": 150,
            "temperature": 0.7
        }
        ...
        message = gpt_response.get('choices', [{}])[0].get('text', 'Sorry, I could not generate a response.')
