...
class create_fb:
    ...
    def scrap1(self): #--> Post Login Awal
        req = bs(self.xyz.get('https://www.facebook.com/r.php?entry_point=login',headers=self.headers_get).content,'html.parser')
        ...
        cok += self.perangkat
        next = 'https://m.facebook.com/reg/?privacy_mutation_token=eyJ0eXBlIjowLCJjcmVhdGlvbl90aW1lIjoxNzM3MTc4OTQwLCJjYWxsc2l0ZV9pZCI6MjY5NTQ4NDUzMDcyMDk1MX0%3D'
